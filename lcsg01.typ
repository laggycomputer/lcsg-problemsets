...
Throughout winter quarter, you will work on programming problems and additional selected exercises to improve your ability to solve challenges presented in technical interviews.
...
+ You have seen an identical or very similar problem before.
...
Some material may overlap with ICS and math coursework, particularly ICS 6B/6D, 31-33, and 46.
...
Work in the language in widespread conventional use which you know best; this is the most effective way to communicate your ideas to interviewers and your group members.
Languages like JavaScript/TypeScript, Python, and C++ are common choices.
If you apply for a job using a specific language, considering working in that language.
Whichever you use, learn it well; it would be embarrassing and debilitating to look up (too many) language primitives during your limited interview time.
...
Instead, familiarize yourself with the standard library of your language of choice.
...
You could do lots of other things, too.
For some ideas:
...
LeetCode, or any other automated system an employer might use, imposes strict time limits on larger inputs so that correct but inefficiently optimized solutions are not accepted.
...
#table(
    ...
    [$O(n!)$ "factorial time"], [arrangements of $n$ objects in a line], [storing those arrangements]
)
...
Do some research and ensure you know how to access it in your language of choice.
...
#problem_box(
    ...
    solution: [
        ...
        You have seen this complexity class before.
    ]
)
